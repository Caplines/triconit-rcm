...
public interface RcmClaimSubmissionDetailsRepo extends JpaRepository<RcmClaimSubmissionDetails, String> {
	...
	@Query(nativeQuery = true, value = " select "
			...
			+ " providerRefNo,dt.clean_claim cleanClaim,dt.primary_eob_attached primaryEOBAttached "
			+ " from rcm_claims_submission_details dt inner join rcm_user us on us.uuid=dt.submitted_by "
