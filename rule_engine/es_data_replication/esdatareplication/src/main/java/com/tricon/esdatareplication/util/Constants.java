...
public class Constants {
	...
	public static final String QUERY_DATE_CLAUSE_REP="DATE__REP__";
	...
	public static final String PATIENTS_COLUMNS="patient_id,first_name,last_name,salutation,address_1,address_2,city,state,zipcode,home_phone,"+
			"work_phone,ext,status,sex,marital_status,reponsible_party_status,reponsible_party,social_security,"+
			"birth_date,notes,preferred_dentist,preferred_hygienist,,recall_frequency,cleaning_time,receive_calls,"+
			"discount_id,current_bal,thirty_day,sixty_day,ninety_day,contract_balance,estimated_insurance,"+
			"first_visit_date,last_seen_date,cancelled_appointments,charges_mtd,collections_mtd,charges_ytd,collections_ytd,"+
			"failed_appointments,prim_responsible_id,prim_relationship,prim_employer_id,prim_outstanding_balance,"+
			"prim_benefits_remaining,prim_remaininig_deductible,sec_responsible_id,sec_relationship,"+
			...
			"patient_status,policy_holder_status,next_recall_date,last_recall_date,yt_visits,"+
			"next_preventive_appt_time,next_regular_appt_time,school,school_city,employment_status,employment_id_number,"+
			"student_status,medicaid_id,death_indicator,signature_on_file,release_into_on_file,"+
			...
			"last_full_mouth,teethStatus,recallBatch,last_pano_date,pharmacy_id,neither_appointments,"+
			"pre_med,rx_id,missing_teeth,receive_email,chart_id,cell_phone,pager_phone,drivers_license,"+
			"hippa_priv_pract,hipaa_authorization,hippa_priv_pract_date,hipaa_authorization_date,hipaa_consent,"+
			"hipaa_consent_date,prim_member_id,sec_member_id,daily_changes.daily_collections,"+
			...
			"DophinID,password_salt,encrypted_social_security,last_medical_history"; 
