...
public class EagleSoftPatient {
	...
	public void setResponsiblePartyStatus(String responsiblePartyStatus) {
		this.responsiblePartyStatus = responsiblePartyStatus;
	}
	...
	public void setPrimBenefitsRemaining(String primBenefitsRemaining) {
		this.primBenefitsRemaining = primBenefitsRemaining;
	}
