...
public class IVFFormConversionUtil {
	...
	public static Patient copyValueToPatientFROMIVOSGoogle(CaplineIVFFormDto d, Office off, Date date, IVFormType iVFormType) {
		...
		pd2.setD5213142625(d.getD5213142625());
		pd2.setD5213142625fr(d.getD5213142625fr());
		pd2.setD2954(d.getD2954());	
		pd2.setD2954fr(d.getD2954fr());	
		...
		pd2.setExams6(d.getExams6());
		pd2.setD0180(d.getD0180());
	...
	public static IVFTableSheet copyValueToIVFSheet(CaplineIVFFormDto d, Office off,boolean setIVFHis) {
		...
		//new in IVF html form
				...
				pd.setD5213142625(d.getD5213142625());
				pd.setD5213142625fr(d.getD5213142625fr());
				pd.setD2954(d.getD2954());	
				pd.setD2954fr(d.getD2954fr());	
				...
				pd.setExams6(d.getExams6());
				pd.setD0180(d.getD0180());
