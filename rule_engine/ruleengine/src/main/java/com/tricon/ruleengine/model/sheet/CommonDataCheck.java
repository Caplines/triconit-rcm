...
public class CommonDataCheck {
	
	
	private String id;
	private String apptId;
	private CommonDataPatient patient;
	private CommonDataDetails cdDetails;
	...
	public CommonDataCheck() {
		
	}
	
	public CommonDataCheck(String id, String apptId, CommonDataPatient patient,
			CommonDataDetails cdDetails, String lineItem, String serviceCode, String description,
	...
	public CommonDataPatient getPatient() {
		return patient;
	}

	public void setPatient(CommonDataPatient patient) {
		this.patient = patient;
	}

	public CommonDataDetails getCdDetails() {
		return cdDetails;
	}

	public void setCdDetails(CommonDataDetails cdDetails) {
		this.cdDetails = cdDetails;
	}
