...
@Configuration
@EnableWebSecurity
public class WebSecurityConfigOLdBAsic  {
 
   // @Autowired
    UserDetailsServiceImplNotUSed userDetailsService;
 ...
 * https://github.com/szerhusenBC/jwt-spring-security-demo/tree/master/src/main/java/org/zerhusen/security
 *
 **/
