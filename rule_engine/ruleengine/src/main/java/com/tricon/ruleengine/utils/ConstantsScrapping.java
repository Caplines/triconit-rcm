...
public class ConstantsScrapping {

	
	public static final String MCNA_ELIG = "MCNA - Eligibility Check";
	...
	public static final int MCNA_ROSTER_ROW_INDEX_STATUS=0;
	public static final int MCNA_ROSTER_COLUMN_INDEX_STATUS=7;
