    ...
    items =[
    	{
    	 ...
    	 data:[
    		...
    		{name: "Policy <br/>Holder:", type: "fill",value:"Alejandro Vera", dt:true,idn:6,idv:25,ch:1,cv:1,rc:1},
    		{name: "Patient<br/> DOB:", type: "fill",value:"2005-09-12", dt:true,idn:7,idv:25,ch:1,cv:1,rc:1}
    	     ]
...

{
   ...
   { 
    a:[
		{name: "Office<br/> Name", type: "dpf",value:"Lavaca", dt:false,idn:1,idv:21},
		{name: "Patient<br/> Name", type: "fill",value:"Test", dt:false,idn:2,idv:22},
		{name: "Insurance<br/> Name", type: "fill",value:"abc", dt:false,idn:3,idv:23},
		{name: "Tax ID", type: "fill",value:"113", dt:false,idn:4,idv:24},
		{name: "Patient<br/> DOB", type: "fill",value:"01/01/2006", dt:true,idn:5,idv:25}
	     ],
     b:[
{name: "Office<br/> Name", type: "dpf",value:"Lavaca", dt:false,idn:1,idv:21},
		{name: "Patient<br/> Name", type: "fill",value:"Test", dt:false,idn:2,idv:22},
